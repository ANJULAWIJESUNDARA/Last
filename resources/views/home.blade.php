...
<link rel="icon" href="{{asset('event/images/favicon.ico')}}">
<link rel="shortcut icon" href="{{asset('event/images/favicon.ico')}}" />
<link rel="stylesheet" href="{{asset('event/css/touchTouch.css')}}">
  ...
  <div class="container">
    <div class="row">
      <div class="page1_block">
        <div class="grid_6">
          <img src="{{asset('event/images/page1_img1.jpg')}}" alt="">
        </div>
        <div class="grid_6">
          <h2>Best Ideas for <br> Your Parties</h2>
          <div class="row">
            <div class="grid_3">
              <img src="{{asset('event/images/page1_img2.jpg')}}" alt="">
            </div>
            <div class="grid_3">
              <img src="{{('event/images/page1_img3.jpg')}}" alt="">
            </div>
          </div>
        </div>
      </div>
        ...
        <div class="grid_4">
           <div data-si-mousemove-trigger="100" class="shuffle-me shuff__1">
            ...
            <div class="images">
              ...
              <img src="{{asset('images/shuffle_3.jpg')}}" alt="">
              <img src="{{asset('images/shuffle_4.jpg')}}" alt="">
            </div></div>
             <div data-si-mousemove-trigger="100" class="shuffle-me shuff__1">
            <a href="#" class="info"><div class="shuffle_title">Corporate Event <span>More</span></div></a>
            <div class="images">
              <img src="{{asset('images/page1_img6.jpg')}}" alt="">
              <img src="{{asset('images/shuffle_5.jpg')}}" alt="">
              <img src="{{asset('images/shuffle_6.jpg')}}" alt="">
            </div></div>
        </div>
        <div class="grid_12">
          <h3>Welcome</h3>
